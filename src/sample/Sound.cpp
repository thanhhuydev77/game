...
void Sound::loadcontent()
{
	...
	loadSound("content\\sound\\broken_brick.wav", "broken_brick");
	loadSound("content\\sound\\hit.wav", "hit");
	loadSound("content\\sound\\splashwater.wav", "splashwater");
	loadSound("content\\sound\\man1.wav", "man1");
	loadSound("content\\sound\\display_monney.wav", "display_monney");
	loadSound("content\\sound\\holycross.wav", "holycross");
	loadSound("content\\sound\\holywater.wav", "holywater");
	loadSound("content\\sound\\InvisibilityPotion_Begin.wav", "InvisibilityPotion_Begin");
	loadSound("content\\sound\\InvisibilityPotion_End.wav", "InvisibilityPotion_End");
	loadSound("content\\sound\\opendoor.wav", "opendoor");
	loadSound("content\\sound\\StopWatch.wav", "StopWatch");
	loadSound("content\\sound\\usingdagger.wav", "usingdagger");
	loadSound("content\\sound\\usingwhip.wav", "usingwhip");
	loadSound("content\\sound\\hurting.wav", "hurting");
	loadSound("content\\sound\\Axe.wav", "Axe");
	loadSound("content\\sound\\collectitem.wav", "collectitem");
	loadSound("content\\sound\\collectweapon.wav", "collectweapon");
