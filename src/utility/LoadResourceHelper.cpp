...
void LoadResourceHelper::loadtextures(string path)
{
	...
	CTextures * textures = CTextures::GetInstance();
	const string texture_name_collection[] = { "ID_TEX_MARIO","ID_TEX_ENEMY","ID_TEX_MISC","ID_TEX_SIMON","ID_TEX_WHIP","ID_TEX_MAP1","ID_TEX_BBOX","ID_TEX_BRATIZER","ID_TEX_LARGE_HEART","ID_TEX_WHIP_POWER_UP","ID_TEX_SWORD","ID_TEX_MAP2","ID_TEX_ITEM","ID_TEX_BITEM","ID_TEX_MAP3","ID_TEX_STATIC_OBJ"};
	const int texture_collection[] = { ID_TEX_MARIO,ID_TEX_ENEMY,ID_TEX_MISC,ID_TEX_SIMON,ID_TEX_WHIP,ID_TEX_MAP1,ID_TEX_BBOX,ID_TEX_BRATIZER,ID_TEX_LARGE_HEART,ID_TEX_WHIP_POWER_UP,ID_TEX_SWORD,ID_TEX_MAP2,ID_TEX_ITEM,ID_TEX_BITEM,ID_TEX_MAP3,ID_TEX_STATIC_OBJ };
	int numberofname = 16;
	string idtex;
	string pathimage;
	int trans_r;
