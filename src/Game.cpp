...
*/
void CGame::Draw(float x, float y, LPDIRECT3DTEXTURE9 texture, int left, int top, int right, int bottom, int alpha, double ScaleX, double ScaleY)
{
	...
	spriteHandler->GetTransform(&old);
		...
		D3DXMATRIX scale;
		D3DXMatrixTransformation2D(&scale, &center, 0.0f, &D3DXVECTOR2(ScaleX*1.0f, ScaleY*1.0f), NULL, 0.0f, NULL);
